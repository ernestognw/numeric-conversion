...
const Card = styled.div`
  ...
  &:hover {
    box-shadow: ${props => (props.noHover ? props.theme.shadow : props.theme.shadowHover)};
    transition: 0.5s all;
  }
`;
...
export { Card, CardHeaderContainer, CardBody, CardFooter, HeaderTitle, HeaderSubtitle };
